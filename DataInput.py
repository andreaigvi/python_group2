...
#print(c.getCorrelationList(findStock('AAPL'), Stock_List))
#print(c.getLeastCorrelatedCompany(findStock('AAPL'), Stock_List))
c.printLeastCorrelatedCompany(findStock('AAPL'), Stock_List)

#print(c.getHighestCorrelatedCompany(findStock('AAPL'), Stock_List))
